...
namespace hg.ApiWebKit.core.attributes
{
	...
	{
		public HttpResponseBinaryValueAttribute():base(MappingDirection.RESPONSE,null) 
		{ 
			
		}

		public HttpResponseBinaryValueAttribute(string field):base(MappingDirection.RESPONSE,field) 
		{ 
