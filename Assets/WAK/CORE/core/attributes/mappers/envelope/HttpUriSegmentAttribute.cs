...
namespace hg.ApiWebKit.core.attributes
{
	...
	{
		public HttpUriSegmentAttribute():base(MappingDirection.REQUEST,null) { }

		public HttpUriSegmentAttribute(string expression):base(MappingDirection.REQUEST,expression) { }
